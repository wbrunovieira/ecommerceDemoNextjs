...
export async function getProductsByCategoriesId(
  ...
  console.log("getProductsByCategoriesId response", response);
  console.log("getProductsByCategoriesId response", response);

  console.log("getProductsByCategoriesId response data", data);
  ...
  console.log("products primeiro", products[0]);
  console.log("products sexto", products[5]);

    ...
    return (
        ...
        >
            ...
            <button
                disabled={!value}
                type="submit"
                className="absolute right-2 top-1/2  -translate-y-1/2 h-8 w-8 rounded-full disabled:bg-primary bg-darkSecondary dark:bg-primary dark:disabled:bg-primaryDark transition duration-200 flex items-center justify-center"
            >
                <motion.svg
                    ...
                    className="text-primaryLight dark:text-primaryLight h-4 w-4"
                >
